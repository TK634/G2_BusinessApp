...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user02);
        ...
        User3_CharacterInformation cha = new User3_CharacterInformation();
        btn_character.setOnClickListener(v -> {


            User3_Character character = new User3_Character(nationality.getText().toString(), age.getText().toString(), name.getText().toString());
